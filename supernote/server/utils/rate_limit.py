...
LIMIT_CHALLENGE_IP_MAX = 20
LIMIT_CHALLENGE_IP_WINDOW = 60  # 1 minute
CHALLENGE_KEY_IP = "challenge:ip"

LIMIT_CHALLENGE_ACCOUNT_MAX = 10
LIMIT_CHALLENGE_ACCOUNT_WINDOW = 60  # 1 minute
CHALLENGE_KEY_ACCOUNT = "challenge:account"
